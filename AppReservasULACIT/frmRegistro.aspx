    ...
    <div id="myModal" class="modal">
        <form class="modal-content animate" runat="server">
            ...
            <div class="container">
                ...
                <asp:TextBox ID="txtTelefono" Placeholder="Ingrese su Telefono" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator ID="rfvTelefono" runat="server" ForeColor="Maroon"
                    ErrorMessage="El telefono es requerido" ControlToValidate="txtTelefono"></asp:RequiredFieldValidator>
